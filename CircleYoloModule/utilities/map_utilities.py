...
def get_bboxes(model, loader, use_amp = False, device = 'cuda', IoU_threshold: float = 0.5, threshold: float = 0.5, S: int = 7, C: int = 1):
    """
    ...
    for batch_idx, (x, labels) in enumerate(loader):
        ...
        bboxes = grid_boxes_to_boxes(predictions, device=device, S=S, C=C)
        true_labels = grid_boxes_to_boxes(labels, device=device, S=S, C=C)
